...
// El optimistic update es una técnica que permite actualizar el estado de la UI antes de recibir la respuesta del servidor, mejorando la experiencia del usuario al hacer que la aplicación se sienta más rápida y receptiva. En este caso, se simula un comentario optimista que se 
// muestra inmediatamente en la UI mientras se espera la confirmación del servidor.
...
export const InstagromApp = () => {
  ...
  // el primer aregumento es el estado incial, la segunda es un reducer
  //tenemos el state y dispatch  , se debe regresar un nuevo estad
  ...
  const handleAddComment = async (formData: FormData) => {
    ...
    addOptimisticComment(messageText); //Agreega el comentario, aun sin esperar la respuesta del servidor
    startTransition(async()=> {  // todo dentro de aca no bloquea el UI, se ejecuta en segundo plano
