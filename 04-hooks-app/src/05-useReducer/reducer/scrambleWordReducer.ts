...
export const scrambleWordsReducer = (state: ScrambleWordsState,
  action: ScrambleWordsAction): ScrambleWordsState => {
    ...
    switch(action.type) {
        ...
        case 'SKIP_WORD':{
          ...
          const upddateWords = state.words.slice(1)

          return {
            ...state,
            skipCounter: state.skipCounter +1,
            words: upddateWords,
            currentWord: upddateWords[0],
            scrambledWord: scrambleWord(upddateWords[0]),
            guess: ''
          }
        }
