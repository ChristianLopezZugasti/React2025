...
export const CustomHeader = () => {
  ...
  const { gender} = useParams() //son rutas de codigo, yua la habiamos definido
  ...
  const handleSearch = (event: KeyboardEvent<HTMLInputElement>) => {
    ...
    const newSearchParams = new URLSearchParams() //estamos creando un nuevo url, borrando todo lo anterior
    if(!query) {
